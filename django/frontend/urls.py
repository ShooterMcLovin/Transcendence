...
from .views import register, login, logout,check_online, check_authentication, user_list, update_password,  get_username, get_usernames, update_winner, user_profile, match_history, add_friend, getUser, remove_friend
